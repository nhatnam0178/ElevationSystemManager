...
public final class ComplainDAO {
	public boolean insertComplain(Orders order_id, Account account_id, boolean is_chargeable, String problem, Date date_complain,
			Status_Complain status_id, String technician_person)
	{
		String[] params = {
				String.valueOf(order_id),String.valueOf(account_id),String.valueOf(is_chargeable),
				problem , String.valueOf(date_complain),String.valueOf(status_id),String.valueOf(technician_person)
		};
	...
	public boolean editComplain(int id, Orders order_id, Account account_id, boolean is_chargeable, String problem, Date date_complain,
			Status_Complain status_id, String technician_person) {
